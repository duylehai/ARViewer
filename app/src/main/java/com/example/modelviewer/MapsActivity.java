...
public class MapsActivity extends AppCompatActivity implements
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        longtitude = bundle.getFloat("Longtitude");
        latitude = bundle.getFloat("Latitude");

        mMap = googleMap;

        // Pan the camera to your home address (in this case, Google HQ).
        LatLng park = new LatLng(latitude, longtitude);
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(park, INITIAL_ZOOM));
        MarkerOptions markerOptions = new MarkerOptions()
                .title("PINNED ADDRESS")
                .position(park)
                .draggable(true)
                .alpha(0.5f).icon(BitmapDescriptorFactory.defaultMarker
